...
dataset = '3DMatch'
experiment_id = f"EGNN_{dataset}_{time.strftime('%m%d%H%M')}"
...
net_arg.add_argument('--num_channels', type=int, default=16)
net_arg.add_argument('--num_iterations', type=int, default=10, help='power iteration algorithm')
net_arg.add_argument('--ratio', type=float, default=0.6, help='max ratio of seeding points')
net_arg.add_argument('--k', type=int, default=16, help='size of local neighborhood')
...
if dataset == '3DMatch':
    data_arg.add_argument('--root', type=str, default='/home/eavise3d/Downloads/3DMatch_Feature')
    ...
    data_arg.add_argument('--root', type=str, default='/home/eavise3d/Downloads/KITTI_Feature')
    data_arg.add_argument('--descriptor', type=str, default='fcgf', choices=['fcgf', 'fpfh'])
